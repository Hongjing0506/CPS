...
def Coupler_Prep(casecfg, envcfg, gridname):
    ...
    if Go_Coupler_Prep:
        ...
        # link unstructured_cwrf
        history_file = f'{unstructured_cwrf_path}/history/unstructured_cwrf_{gridname}_hist_{StartTime.year}.nc'
        Tools.File_Exist(history_file, level='error')
        Tools.Link(history_file, f'./{gridname}/CoLM_ref_{gridname}_vector.nc')
