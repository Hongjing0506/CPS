...
daysta=$3
dayend=$4
#BASE_DIR=/scratch/users/xhr@umd.edu/DATA/MPI_ICBC/ICBC/ICBC_US/${yr}_T/
#BASE_DIR=/work-zfs/xliang/MPI_ICBC_CN/20th/${yr}/
# "+YR+MON+"_met
yrstr=`printf "%04d" $yr`
monstr=`printf "%02d" $mon`
daystastr=`printf "%02d" $daysta`
dayendstr=`printf "%02d" $dayend`
BASE_DIR=/share/home/dq048/oscar/future/ICBC_RUN/SSP245/MPI_MET/${yrstr}_${monstr}_met/
